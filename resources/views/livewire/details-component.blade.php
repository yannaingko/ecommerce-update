                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    ...
                                    <ul class="product-meta font-xs color-grey mt-50">
                                        ...
                                        <li>Availability:
                                            @if($product->stock_status == 'instock')
                                                <span class="in-stock text-success ml-5">{{$product->quantity}} Items In Stock</span>
                                            @else
                        ...
                        <div class="tab-style3">
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Reviews">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{asset('assets/imgs/page/avatar')}}/{{auth()->user()->name}}/{{auth()->user()->avatar}}" alt="">
                                    ...
                                    <!--comment form-->
                                    {{-- <a href="{{route('user.review')}}" class="btn">Make Review</a> --}}
                                    <div class="col-7 mx-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                <h6 class="text-info mb-2">Share Your Experience Feel free</h6>
                                                <form wire:submit.prevent="makereview({{$product->id}})">
                                                    <div class="rating">
                                                        <label>
                                            ...
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('assets/imgs/products/product-2-1.jpg')}}" alt="">
                                                        <img class="hover-img" src="{{asset('assets/imgs/products/product-2-2.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('assets/imgs/products/product-3-1.jpg')}}" alt="">
                                                        <img class="hover-img" src="{{asset('assets/imgs/products/product-4-2.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('assets/imgs/products/product-4-1.jpg')}}" alt="">
                                                        <img class="hover-img" src="{{asset('assets/imgs/products/product-4-2.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        <div class="product-cart-wrap small hover-up mb-0">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('assets/imgs/products/product-5-1.jpg')}}" alt="">
                                                        <img class="hover-img" src="{{asset('assets/imgs/products/product-3-2.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="product-action-1">
                                                    <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{asset('assets/imgs/products/thumbnail-3.jpg')}}" alt="#">
                            </div>
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{asset('assets/imgs/products/thumbnail-4.jpg')}}" alt="#">
                            </div>
                            <div class="content pt-10">
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="{{asset('assets/imgs/products/thumbnail-5.jpg')}}" alt="#">
                            </div>
                            <div class="content pt-10">
