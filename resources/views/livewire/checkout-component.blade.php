                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-25">
                                ...
                                <div class="form-group">
                                    <input required="" type="text" name="cname" placeholder="Company Name" wire:model="companyname">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="billing_address2" required="" placeholder="Address line2" wire:model=""address_line2>
                                </div>
                                <div class="form-group">
                                    <input required="" type="text" name="city" placeholder="City / Town *" wire:model="city">
                                </div>
                                <div class="form-group">
                                    <input required="" type="text" name="state" placeholder="State / County *" wire:model="stage">
                                </div>
                                <div class="form-group">
                                    <input required="" type="text" name="zipcode" placeholder="Postcode / ZIP *" wire:model="zip">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="ship_detail">
                                    ...
                                    <div id="collapseAddress" class="different_address collapse in">
                                        ...
                                        <div class="form-group">
                                            <input required="" type="text" name="cname" placeholder="Company Name" wire:model="s_company">
                                        </div>
                                        <div class="form-group">
                                            <div class="custom_select">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="billing_address" required="" placeholder="Address *" wire:model="s_address">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="billing_address2" required="" placeholder="Address line2" wire:model="s_address_line2">
                                        </div>
                                        <div class="form-group">
                                            <input required="" type="text" name="city" placeholder="City / Town *" wire:model="s_city">
                                        </div>
                                        <div class="form-group">
                                            <input required="" type="text" name="state" placeholder="State / County *" wire:model="s_stage">
                                        </div>
                                        <div class="form-group">
                                            <input required="" type="text" name="zipcode" placeholder="Postcode / ZIP *" wire:model="s_zip">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-20">
