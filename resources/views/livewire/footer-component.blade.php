                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Bokalay Zay
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+95 0000-000-000
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>
                            </p>
                    ...
                    <div class="col-lg-4 col-md-3">
                          <iframe                         
                            ...
                            marginheight="0" 
                            marginwidth="0" 
                            src="https://maps.google.com/maps?q=16.774292,96.161581&hl=es&z=14&amp;output=embed"
                            >
                            </iframe>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="float-md-left font-sm text-muted mb-0">
                        <a href="{{route('p&p')}}">Privacy Policy</a> | <a href="terms-conditions.html">Terms & Conditions</a>
                    </p>
                </div>
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Online Shop</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
